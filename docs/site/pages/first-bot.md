...
the three minutes ran out. In overtime Blue brought down Red's king tower at tick 4295, 34.75
...
else at all (run 2026-09-25 on engine build `734032113c44fbcc` with the 15.535 card table).
