...
the three minutes ran out. In overtime Blue brought down Red's king tower at tick 4293, 34.65
...
else at all (run 2026-09-25 on engine build `7435c213f7e9c9de` with the 15.535 card table).
