...
![tests](https://img.shields.io/badge/tests-478%20passed-2ea043?style=flat-square)
...
against another, the metrics output and the checkpoint store. That is 478 passing tests.
