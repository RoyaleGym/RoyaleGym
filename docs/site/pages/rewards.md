...
build `192dc2cec54da9d3` with the 15.535 card table. A newer engine can end the battle
...
```
CombinedReward: blue total +1.236  over 373 steps, 110 of them non-zero
{
  "terms": [
    {
      "class": "WinLossReward",
